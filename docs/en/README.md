...
A small, dependency-free-to-the-user web app for learning basic piano theory
and practicing the C major scale, with optional MIDI keyboard support. Built
...
1. Make sure the "Synth sound for MIDI" toggle in the "On-screen keyboard"
   section is on — it is off by default so it does not double the sound of an
