...
export const ES = {
  ...
  practice: {
    ...
    roundInfinite: "Vuelta: <strong>{round}</strong> / \u221e",
    infinite: "\u221e",
  ...
  task: {
    ...
    roundDoneCredited: "Vuelta completada, el ejercicio cuenta — sigue tocando cuanto quieras.",
    roundDoneInfinite: "Vuelta {round} completada — toca otra vez o pulsa «Reiniciar».",
