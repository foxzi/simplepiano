...
export const EN = {
  ...
  practice: {
    ...
    roundInfinite: "Round: <strong>{round}</strong> / \u221e",
    infinite: "\u221e",
  ...
  task: {
    ...
    roundDoneCredited: "Round complete, the exercise counts \u2014 keep playing as long as you like.",
    roundDoneInfinite: "Round {round} complete \u2014 play it again or press \u201cReset\u201d.",
